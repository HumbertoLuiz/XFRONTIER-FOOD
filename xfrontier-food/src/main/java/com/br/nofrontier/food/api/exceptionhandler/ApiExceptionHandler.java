...
import com.br.nofrontier.food.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public static final String MSG_ERROR_GENERIC_USER_FINAL = "An unexpected internal system error has occurred. Try again and if "
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("The %s resource you tried to access is non-existent.", ex.getRequestURL());

		Problem problem = createProblemBuilder(status, problemType, detail).userMessage(MSG_ERROR_GENERIC_USER_FINAL)
				.build();
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		String detail = String.format(
				"The URL parameter '%s' was given the value '%s', "
						+ "which is of an invalid type. Correct it and enter a value compatible with the %s type.",
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		ProblemType problemType = ProblemType.UNINTELLIGIBLE_MESSAGE;
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.UNINTELLIGIBLE_MESSAGE;
		String detail = String.format(
				"The property '%s' was given the value '%s', "
						+ "which is of an invalid type. Correct it and enter a value compatible with the %s type.",
